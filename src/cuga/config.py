...
validators = [
    ...
    Validator("observability.traceloop", default=False),
    Validator("observability.traceloop_exporter", default="file"),
    Validator("observability.traceloop_file_path", default=""),
