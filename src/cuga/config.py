...
validators = [
    ...
    Validator("context_forge.enabled", default=False),
    Validator("context_forge.url", default=""),
    Validator("context_forge.audience", default=""),
    Validator("context_forge.workspace_group", default=""),
    Validator("context_forge.token_source", default="env"),
    Validator("context_forge.token_env_var", default="CONTEXT_FORGE_TOKEN"),
    Validator("context_forge.verify_ssl", default=True),
    Validator("context_forge.ca_bundle", default=""),
