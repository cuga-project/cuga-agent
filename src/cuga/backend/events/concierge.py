...
SINGLE-AGENT WORLD (events/docs/plans/SUPERVISOR_REFACTOR.md): the concierge does NO agent
...
# THE one addressable agent (supervisor model — events/docs/plans/SUPERVISOR_REFACTOR.md).
...
class Concierge:
    ...
    async def _arm_spec(self, thread_id: str, p, spec, utterance: str) -> str | None:
        ...
        (events/docs/plans/SUPERVISOR_REFACTOR.md)."""
