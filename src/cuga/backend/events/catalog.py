...
EXAMPLES = [
    ...
    _ex("push-github-pr", "GitHub PR summarizer", "push",
        "when a new PR opens on my repo, summarize it and message me",
        agent="—", channel="telegram", integration="github", phase="run", live=False,
        note="GitHub PUSH — recommended FIRST push test (no token time-window)"),
    ...
    _ex("push-webhook-in", "Generic inbound webhook", "push",
        ...
        agent="—", channel="web", integration="webhook", phase="run", live=False,
        note="GENERIC WEBHOOK-IN (MVP) — any external system → your agent, no bespoke piece"),
