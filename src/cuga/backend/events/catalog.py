...
EXAMPLES = [
    ...
    _ex(
        ...
        "Latest papers now",
        "now",
        "3 latest arXiv papers on mixture-of-experts",
        agent="papers",
        channel="web",
        phase="run",
        live=True,
        note="router → papers (one-shot)",
    ),
    ...
    _ex(
        ...
        "City briefing",
        "now",
        "brief me on Lisbon — weather, key facts, things to do",
        agent="city_briefing",
        channel="web",
        phase="run",
        live=True,
    ...
    _ex(
        ...
        "AI labs digest",
        "now",
        "what's new from OpenAI and Anthropic this week?",
        agent="ai_labs_news",
        channel="web",
        phase="run",
        live=True,
    ...
    _ex(
        ...
        "Find meetups",
        "now",
        "AI/ML meetups in San Francisco in the next two weeks",
        agent="meetup_finder",
        channel="web",
        phase="run",
        live=True,
    ...
    _ex(
        "now-feed",
        "What's new in a feed",
        "now",
        "what's new on https://hnrss.org/frontpage ?",
        agent="feed_watcher",
        channel="web",
        phase="run",
        live=True,
    ...
    _ex(
        "cron-brief",
        "Weekday market brief",
        "cron",
        "every weekday at 8am send me a market brief",
        agent="market_briefer",
        channel="telegram",
        phase="run",
        live=True,
    ...
    _ex(
        "cron-slack-digest",
        "Overnight support digest → Slack",
        "cron",
    ...
    _ex(
        ...
        note="Google Calendar new_event → mailbot",
    ),
    _ex(
        "push-pinterest-pin",
        "Pinterest pin watcher",
        "push",
        ...
        note="Pinterest new_pin (needs a board id) → feed_watcher",
    ),
    _ex(
        "push-youtube-video",
        "YouTube upload watcher",
        "push",
    ...
    _ex(
        "push-webhook-routed",
        "⭐ Webhook that picks its own agent",
        "push",
    ...
    _ex(
        ...
        "Daily price ping",
        "cron",
        "every day at 9am send me the price of bitcoin",
        agent="pricebot",
        channel="telegram",
        phase="run",
        live=True,
    ...
    _ex(
        ...
        "Morning weather",
        "cron",
        "every morning at 7am send me the weather in New York",
        agent="weatherbot",
        channel="telegram",
        phase="run",
        live=True,
    ...
    _ex(
        ...
        "Market brief now",
        "now",
        "give me a market brief right now",
        agent="market_briefer",
        channel="web",
        phase="run",
        live=True,
    ...
    _ex(
        ...
        "Trending repos now",
        "now",
        "show me the top trending GitHub repos right now",
        agent="github_trending",
        channel="web",
        phase="run",
        live=True,
    ...
    _ex(
        ...
        "Connect my Box",
        "connect",
        "watch my Box folder for new resumes",
        agent="resume_judge",
        channel="web",
        integration="box",
        phase="run",
    ...
    _ex(
        "adv-gmail-attach-resume",
        "Gmail · resume attachment",
        "push",
    ...
    _ex(
        "adv-gmail-attach-summ",
        "Gmail · any attachment",
        "push",
    ...
    _ex(
        "adv-slack-msg-anywhere",
        "Slack · any public message",
        "push",
    ...
    _ex(
        "adv-slack-msg-in-channel",
        "Slack · a message in a channel",
        "push",
    ...
    _ex(
        "adv-slack-mention",
        "Slack · team @mention in a channel",
        "push",
    ...
    _ex(
        "adv-slack-mention-dm",
        "Slack · @mention in a DM",
        "push",
    ...
    _ex(
        "adv-slack-reaction-bug",
        "Slack · a :bug: reaction",
        "push",
    ...
    _ex(
        "adv-slack-reaction-research",
        "Slack · a :bookmark: reaction",
        "push",
    ...
    _ex(
        "adv-slack-reaction-removed",
        "Slack · a reaction is removed",
        "push",
    ...
    _ex(
        "adv-slack-channel-created",
        "Slack · a channel is created",
        "push",
    ...
    _ex(
        "adv-slack-command",
        "Slack · a slash command in a channel",
        "push",
    ...
    _ex(
        "adv-slack-command-dm",
        "Slack · a slash command in a DM",
        "push",
...
def _feasibility(integration: str, ap_trigger: str) -> tuple[str, str]:
    ...
    if integration == "github":
        return (
            "now",
            "armed by the router and FIRED by machine: POST /subscriptions/{id}/run "
    ...
    if integration == "gmail":
        return (
            "manual",
            "arms today (the router selects this exact trigger; the label slot is "
    ...
    if integration == "box":
        return (
            "real",
            "arms today; the direct poller handles files, folders and comments "
    ...
    if integration == "discord":
        need = (
            "; new_member additionally needs the privileged Server Members intent "
            "(dev portal + EVENTS_DISCORD_MEMBERS_INTENT=1)"
            if (t is not None and t.event == "new_member")
            else ""
        )
        return (
            "setup",
            "arms today as a CUGA-owned direct watcher on the Gateway CUGA already holds" + need + ".",
        )
    if integration == "telegram":
        return (
            "real",
            "arms today as a content-filter watcher on the bot's message stream — "
