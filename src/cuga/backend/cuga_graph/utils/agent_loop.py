...
class AgentLoop:
    ...
    def __init__(
        ...
        # Skill's allowed-tools whitelist for this turn only. ``None`` means
        # no restriction. Threaded into RunnableConfig.configurable so the
        # cuga_lite tool-approval gate can check generated code against it.
