...
\coordinate (fa@bl) at (-1.0,1.85);
\coordinate (fa@tr) at (5.5,5.45);
...
\node[agent] (da) at (0.6, 4.1) {\texttt{Decision}\\[-2pt]\texttt{Agent}};
\node[agent] (hm) at (3.8, 4.1) {\texttt{Hook}\\[-2pt]\texttt{reasoning}};
...
\node[draw=black!45, fill=yellow!12, rounded corners=4pt,
      ...
      (bpmn) at (10.9,6.6) {BPMN 2.0 Diagram};
\node[draw=black!45, fill=green!10, rounded corners=4pt,
      minimum width=2.6cm, minimum height=0.85cm, text centered, text width=2.4cm]
      (parser) at (10.9,5.35) {\texttt{BPMNParser}};
