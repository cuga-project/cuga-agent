...
async def solve_crt(remainders: list, moduli: list) -> dict:
    ...
    for all i, or reports that no solution exists (incompatible system).
    ...
    for i in range(1, len(r)):
        ...
        # inv always exists because gcd(cur_m/g, mi/g) = 1 by construction
