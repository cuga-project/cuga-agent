...
1. Set `enable_memory = true`
2. Run `cuga start demo_crm --sample-memory-data`
3. In the UI, type `Identify the common cities between my cuga_workspace/cities.txt and cuga_workspace/company.txt`
4. Wait for tips to be generated in-process, then rerun the same utterance and verify fewer steps
